...
class AndroidGMARewardedInterstitialAd:
    def __init__(
        self,
        ad_unit_id: str,
        ...
        self._j_ad = AndroidBridge.PyRewardedInterstitialAd(
            AndroidBridge.activity, ad_unit_id
        )

        self.on_reward_earned = on_reward_earned
    ...
    def _poll_ad_events(self):
        while self._keep_monitoring:
            if self._j_ad.checkAndResetReward() and self.on_reward_earned:
                self.on_reward_earned()
